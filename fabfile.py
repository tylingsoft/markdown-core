...
def fonts():
    ...
    for font in """https://cdn.jsdelivr.net/fontawesome/4.5.0/fonts/fontawesome-webfont.eot
...
def css():
    ...
    local('curl https://cdn.jsdelivr.net/emojione/2.0.1/assets/css/emojione.min.css >> dist/markdown-core.css')
    ...
    local('curl https://cdn.jsdelivr.net/katex/0.5.1/katex.min.css >> dist/markdown-core.css')
...
def js():
    ...
    local('curl https://cdn.jsdelivr.net/jquery/2.2.0/jquery.min.js >> dist/markdown-core.js')
    local('echo "\n" >> dist/markdown-core.js')
    local('curl https://cdn.jsdelivr.net/js-cookie/2.1.0/js.cookie.js >> dist/markdown-core.js')
    local('echo "\n" >> dist/markdown-core.js')
